...
const getOptions = (redirect) => {
  return {
    responseType: 'token id_token',
    redirectUri: `${getBaseUrl()}/auth/signed-in?redirect=${redirect}`,
    scope: 'openid profile email'
  }
}

export const authorize = (redirect) => getAuth0().authorize(getOptions(redirect))
